...
// Store Grafana admin password in AWS Secrets Manager for secure access
const grafanaAdminSecret = new aws.secretsmanager.Secret("grafana-secret", {
...
new aws.secretsmanager.SecretVersion("grafana-secret-version", {
